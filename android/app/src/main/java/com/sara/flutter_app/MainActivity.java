   ...
   private IProviderBinder binder;
    ...
    private void openCheckoutUI(String checkoutId) {
        ...
        CheckoutSettings checkoutSettings =  new CheckoutSettings(checkoutId,paymentBrands,
                Connect.ProviderMode.TEST).setShopperResultUrl("com.sara.flutterapp://result");

        if (mode.equals("LIVE")) {
            checkoutSettings =  new CheckoutSettings(checkoutId,paymentBrands,
                    Connect.ProviderMode.LIVE).setShopperResultUrl("com.sara.flutterapp://result");
        }
    ...
    private void openCustomUI(String checkoutid) {
        ...
        if (STCPAY.equals("enabled")) {
            ...
            try {
                ...
                paymentParams.setShopperResultUrl("com.sara.flutterapp://result");
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (intent.getScheme().equals("com.sara.flutter_app")) {
